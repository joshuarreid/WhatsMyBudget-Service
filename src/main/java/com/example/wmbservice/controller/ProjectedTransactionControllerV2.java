...
public class ProjectedTransactionControllerV2 {
    ...
    /**
     * Overload: list projected transactions by inclusive transactionDate range.
     */
    ...
    public ResponseEntity<?> getTransactionsByDateRange(
        ...
        logger.info("[v2] getProjectedTransactionsByDateRange entered. transactionId={}, startDate={}, endDate={}, account={}, category={}, criticality={}, paymentMethod={}",
        ...
        try {
            ...
            logger.error("[v2] Error fetching projected transactions by date range. transactionId={}, error={}", transactionId, e.getMessage(), e);
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .header("X-Transaction-ID", transactionId)
                    .body(new ErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR.value(), "LIST_ERROR", "Unexpected error", transactionId));
        }
    ...
    public ResponseEntity<?> getAccountProjectedTransactionListByDateRange(
        ...
        logger.info("[v2] getAccountProjectedTransactionListByDateRange entered. transactionId={}, account={}, startDate={}, endDate={}",
        ...
        try {
            ...
            logger.error("[v2] Error fetching account projected transactions by date range. transactionId={}, error={}", transactionId, e.getMessage(), e);
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .header("X-Transaction-ID", transactionId)
                    .body(new ErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR.value(), "ACCOUNT_LIST_ERROR", "Unexpected error", transactionId));
        }
